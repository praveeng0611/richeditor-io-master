$.Richeditorio.prototype.fullscreen = function() {
	return {
		langs: {
			de: {
				"fullscreen": "Vollbild"
		...
		enable: function()
		{
			...
			this.core.box().addClass('richeditorio-box-fullscreen');

			$('body').addClass('richeditorio-body-fullscreen');
			...
			$(window).on('resize.richeditorio-plugin-fullscreen', $.proxy(this.fullscreen.resize, this));
		...
		disable: function()
		{
			...
			$(window).off('resize.richeditorio-plugin-fullscreen');
			$('body, html').css('overflow', '');

			this.core.box().insertBefore(this.$fullscreenPlaceholder);
			this.$fullscreenPlaceholder.remove();

			this.core.box().removeClass('richeditorio-box-fullscreen').css({ width: 'auto', height: 'auto' });
			this.core.box().removeClass('richeditorio-box-fullscreen');
