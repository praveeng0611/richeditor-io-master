$.Richeditorio.prototype.grouplink = function() {
	return {
		langs: {
			de: {
				"grouplink": "Link",
		...
		getEmailTemplate: function() {
			...
			var modalContent = '';
			modalContent += '<div class="modal-section" id="richeditorio-modal-emailgrouplink">';
			...
			modalContent += '  </section>';
			modalContent += '  <section>';
			modalContent += '    <button id="richeditorio-modal-button-action">' + this.lang.get('grouplink_insert') + '</button>';
			modalContent += '    <button id="richeditorio-modal-button-cancel">' + this.lang.get('grouplink_abort') + '</button>';
			modalContent += '  </section>';
			modalContent += '</div>';
		...
		getTelephoneTemplate: function() {
			...
			var modalContent = '';
			modalContent += '<div class="modal-section" id="richeditorio-modal-telephonegrouplink">';
		...
		getExternalTemplate: function() {
			...
			var modalContent = '';
			modalContent += '<div class="modal-section" id="richeditorio-modal-externalgrouplink">';
		...
		{
			var that = this;
			var mediapool = openMediaPool('richeditorio_mediagrouplink');
