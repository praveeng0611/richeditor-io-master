$.Richeditorio.prototype.telephonelink = function() {
	return {
		langs: {
			de: {
		...
		getTemplate: function() {
			...
			var modalContent = '';
			modalContent += '<div class="modal-section" id="richeditorio-modal-telephonelink">';
			...
			modalContent += '  </section>';
			modalContent += '  <section>';
			modalContent += '    <button id="richeditorio-modal-button-action">' + this.lang.get('telephonelink_insert') + '</button>';
			modalContent += '    <button id="richeditorio-modal-button-cancel">' + this.lang.get('telephonelink_abort') + '</button>';
			modalContent += '  </section>';
			modalContent += '</div>';
